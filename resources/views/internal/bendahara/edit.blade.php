                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('internal.bendahara.update', $bendahara->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label>NIP</label>
                                    <input type="text" class="form-control" name="nip" value="{{ old('nip', $bendahara->nip) }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="school" min="1900" max="2100" value="{{ old('school', $bendahara->school) }}">
                                </div>

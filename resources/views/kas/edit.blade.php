                ...
                <div class="card shadow-sm border-0" style="border-radius: 8px;">
                    <div class="card-header bg-white py-3 border-bottom" style="border-top-left-radius: 8px; border-top-right-radius: 8px;">
                        <h5 class="card-title mb-0" style="font-weight: 700; color: #232b38; font-size: 16px;">
                            <i class="fas fa-edit text-info me-2"></i> Form Edit Transaksi Kas
                        </h5>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('kas.update', $transaction->id) }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" class="form-control" name="date" value="{{ old('date', $transaction->date->format('Y-m-d')) }}" style="border-radius: 6px; padding: 10px 15px;">
                                @error('date')
                                    <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="category" value="{{ old('category', $transaction->category) }}" style="border-radius: 6px; padding: 10px 15px;">
                                @error('category')
                                    <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control" name="qty" value="{{ old('qty', $transaction->qty) }}" min="1" style="border-radius: 6px; padding: 10px 15px;">
                                        @error('qty')
                                            <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="nominal" class="form-control" value="{{ old('nominal', $transaction->nominal) }}" min="0" style="border-radius: 0 6px 6px 0; padding: 10px 15px;">
                                        </div>
                                        @error('nominal')
                                            <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                        @enderror
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control" name="pic" value="{{ old('pic', $transaction->pic) }}" placeholder="Nama penanggung jawab" style="border-radius: 6px; padding: 10px 15px;">
                                @error('pic')
                                    <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="text-end pt-2 border-top">
                                ...
                                <button type="submit" class="btn btn-info text-white" style="border-radius: 6px; padding: 8px 25px; font-weight: 600;">
                                    Simpan Perubahan
                                </button>
                            </div>
                        </form>

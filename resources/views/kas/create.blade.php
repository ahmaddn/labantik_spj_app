            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h5 class="card-title text-white mb-0">Form Transaksi Kas</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('kas.store') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="category" value="{{ old('category') }}" placeholder="Contoh: Pembelian Alat Tulis, Kas Masuk SPJ, dll.">
                                @error('category')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" name="qty" value="{{ old('qty', 1) }}" min="1">
                                @error('qty')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control" name="pic" value="{{ old('pic') }}" placeholder="Nama penanggung jawab">
                                @error('pic')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
